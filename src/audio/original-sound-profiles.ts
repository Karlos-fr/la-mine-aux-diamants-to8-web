...
/** Table melodique lue par la routine `ENTET.BIN:$941F` pour la musique de l'ecran 2. */
export const TITLE_MUSIC_DAC_TABLE = [
  ...
  0x34, 0x1c, 0x20, 0x22, 0x26, 0x2b, 0x31, 0x26, 0x2b, 0x31, 0x34, 0x3b,
  0x34, 0x2b, 0x47, 0x3b, 0x43, 0x50, 0x43, 0x34, 0x26, 0x22, 0x20, 0x1c,
  0x20, 0x22, 0x26, 0x2b
] as const;
...
/** Constante de conversion historique du portage, conservee car plus proche a l'oreille du titre original. */
