...
La logique gameplay doit avancer en ticks entiers. Le rendu fluide peut interpoler entre deux etats logiques, mais il ne doit pas devenir une source de verite pour les collisions, la collecte, les monstres ou la physique.
...
| Mouvement joueur | Routines joueur autour de `$CE..` | 11 ticks | Hypothese moderne | Interpolation fluide moderne arrondie depuis l'ancienne valeur `0.21s` |
...
| Interpolation monstre | Rendu moderne | 9 ticks | Rendu moderne | Interpolation decouplee de la decision logique |
| Scan physique rocher/diamant | `$CB07`, `$CB17` | 8 ticks | Hypothese moderne centralisee | `$CB07` scanne la grille par boucle principale; cadence moderne conservee en ticks |
| Interpolation physique | Rendu moderne | 9 ticks | Rendu moderne | Chute/glissade visible decouplee de la mutation de grille |
...
- Le mode attract est rapproche de l'ordre ASM, mais conserve un rendu fluide moderne.
